...
const file_example_v1_example_proto_rawDesc = "" +
	...
	"\aDieRoll\x12`\n" +
	"\bThrowDie\x12\x16.google.protobuf.Empty\x1a\x1c.example.v1.ThrowDieResponse\"\x1e\x82\xb5\x18\x1a\x10x\x18x \x1e*\x12\b\x01\x15\x00\x00\xc0?\x18\n" +
	" \n" +
	"*\x05FATAL\x12G\n" +
	...
	"2\bContinue\x12d\n" +
	"\x0fThrowUntilValue\x12\".example.v1.ThrowUntilValueRequest\x1a\x16.google.protobuf.Empty\"\x15\x8a\xb5\x18\x11:\x0fGetThrowsStatus\x12V\n" +
	"\bContinue\x12!.example.v1.ContinueSignalRequest\x1a!.example.v1.ContinueSignalRequest\"\x04\x92\xb5\x18\x00\x12P\n" +
